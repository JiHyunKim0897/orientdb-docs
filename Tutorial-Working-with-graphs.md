...
For troubleshooting information on Lightweight Edges, see [Why I can't see all the edges](Troubleshooting.md#why-cannot-i-see-all-the-edges). For more information in the Graph model in OrientDB, see [Graph API](Graph-Database-Tinkerpop.md).
